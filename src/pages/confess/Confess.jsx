  ...
  return (
    <div className={styles.confess}>
      ...
      <div className={styles.container}>
        <div className={styles.title}>恋爱申请书</div>
        <div className={styles.content}>
        <div className={styles.tomomo}>致 MOMO:</div>
          ...
          <div className={styles.btns}>
            ...
            <button className={styles.accept} onClick={acceptHandler}>同意</button>
          </div>
        </div>
      </div>
      ...
      <div className={styles.footer}>
        <p className={styles.toRighht}>🎉 2025.12.27</p>
      </div>
